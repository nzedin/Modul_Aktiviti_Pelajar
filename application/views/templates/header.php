...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?= base_url('dist/temp')?>/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- JQVMap -->
  <link rel="stylesheet" href="<?= base_url('dist/temp')?>/plugins/jqvmap/jqvmap.min.css">
  <!-- Theme style -->
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?= base_url('dist/temp')?>/plugins/daterangepicker/daterangepicker.css">
  <!-- summernote -->
  <link rel="stylesheet" href="<?= base_url('dist/temp')?>/plugins/summernote/summernote-bs4.min.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  <!-- DataTables -->
  <link rel="stylesheet" href="<?= base_url('dist/temp') ?>/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="<?= base_url('dist/temp') ?>/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
  <!-- Google Font: Source Sans Pro -->
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
  <!-- Select2 -->
  <link rel="stylesheet" href="<?= base_url('dist/temp') ?>/plugins/select2/css/select2.min.css">
  ...
  .table-admin-checkbox:checked:before {
    content: "✔";
    font-size: 18px;
    text-align: center;
    line-height: 20px;
